**You need to dowload the files in the links in order to run the code [(Combined.ipynb)](/code/Combined.ipynb) because the models that we worked with are in those files.**
